...
FILE_NON_REGULATION_CSV  = CLEANED_DIR / "data_none_regulation.csv"
FILE_NON_REGULATION_JSON = CLEANED_DIR / "data_none_regulation.json"
...
# JSON_ANALYZE_READY_FILE = FILE_NON_REGULATION_JSON
